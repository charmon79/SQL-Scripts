...
DECLARE @TimeInterval CHAR(8) = '00:30:00';
...
CREATE TABLE ##WaitStats_charmon (
...
CREATE CLUSTERED INDEX CIX_WaitStats ON ##WaitStats_charmon (PeriodStart, [Percentage])
